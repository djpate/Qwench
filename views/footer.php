...
<?php if (!empty($_SESSION['userid'])):?>
	<div class="userlogin">
		...
		<a href="<?php echo basePath();?>/users/edit"><?php echo _("Edit Profile"); ?></a><br/>
		<a href="<?php echo basePath();?>/users/logout"><?php echo _("Logout"); ?></a></div>
		<div style="clear:both"></div>
	</div>
<?php else:?>
	...
	<div class="userlogin">
		...
		<div style="padding-top:10px"><input type="submit" value="<?php echo _("Login"); ?>" class="button"> <?php echo _("or"); ?> <i><a href="<?php echo basePath();?>/users/register"><?php echo _("click here to register"); ?></a></i>
		</form>
	</div>
	<?php endif;?>
<?php endif;?>
...
<a href="http://www.inscripts.com/qwench" target="_blank"><?php echo _("Powered by Qwench"); ?></a><br/>Copyright 2009-2010 <a href="http://www.inscripts.com" target="_blank">Inscripts</a>
<!-- Copyright Notice Do Not Remove -->
</div>
</body>
</html>