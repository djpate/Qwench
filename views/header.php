...
<div style="float:right;border-left: 1px solid #13a1c9;border-right: 1px solid #45c9e9;"><ol><li><a href="<?php echo basePath();?>"><?php echo _("Home"); ?></a></li><li><a href="<?php echo basePath();?>/questions"><?php echo _("Questions"); ?></a></li><li><a href="<?php echo basePath();?>/tags"><?php echo _("Tags"); ?></a></li><li><a href="<?php echo basePath();?>/users"><?php echo _("Users"); ?></a></li><li><a href="<?php echo basePath();?>/questions?type=unanswered"><?php echo _("Unanswered"); ?></a></li><li><a href="<?php echo basePath();?>/questions/ask"><?php echo _("Ask or Contribute"); ?></a></li></ol></div>
